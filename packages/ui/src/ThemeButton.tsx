...
export const ThemeButton= ()=>{
    ...
    useEffect(()=>{
        ...
        const ifSystemDark=window.matchMedia("(prefers-color-scheme: dark)").matches;
    ...
    <div className="border-red-500 border-1">
        <p> testing tailwind configurations</p>
    </div>
    )
}